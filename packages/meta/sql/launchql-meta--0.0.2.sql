...
ALTER TABLE meta_public.site_themes ADD COLUMN  primary_color text;

ALTER TABLE meta_public.site_themes ALTER COLUMN primary_color SET NOT NULL;

ALTER TABLE meta_public.site_themes ADD CONSTRAINT site_themes_primary_color_chk CHECK ( character_length(primary_color) <= 24 );

ALTER TABLE meta_public.site_themes ADD COLUMN  secondary_color text;

ALTER TABLE meta_public.site_themes ADD CONSTRAINT site_themes_secondary_color_chk CHECK ( character_length(secondary_color) <= 24 );
